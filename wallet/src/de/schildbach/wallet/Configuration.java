...
public class Configuration
{
	...
	public static final String PREFS_KEY_FST_PRECISION = "fst_precision";
	...
	private static final String PREFS_DEFAULT_FST_PRECISION = "2/3";
	...
	{
		return prefs.contains(PREFS_KEY_FST_PRECISION);
	}

	public int getBtcPrecision()
	{
		final String precision = prefs.getString(PREFS_KEY_FST_PRECISION, PREFS_DEFAULT_FST_PRECISION);
		return precision.charAt(0) - '0';
	}

	public int getBtcMaxPrecision()
	{
		return getBtcShift() == 0 ? Constants.FST_MAX_PRECISION : Constants.MFST_MAX_PRECISION;
	}
	...
	{
		return getBtcShift() == 0 ? Constants.CURRENCY_CODE_FST : Constants.CURRENCY_CODE_MFST;
	}
