...
public final class PaymentIntent implements Parcelable
{
	...
	public final static class Output implements Parcelable
	{
		...
		public String toString()
		{
			...
			builder.append('[');
			builder.append(hasAmount() ? GenericUtils.formatValue(amount, Constants.FST_MAX_PRECISION, 0) : "null");
			builder.append(',');
	...
	public static PaymentIntent fromFastcoinUri(@Nonnull final BitcoinURI bitcoinUri)
	{
