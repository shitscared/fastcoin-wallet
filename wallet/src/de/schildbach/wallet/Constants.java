...
public class Constants
{
	...
	public static final String NETWORK_SUFFIX = TEST ? "" : "";//"[testnet]":""

	public static final NetworkParameters NETWORK_PARAMETERS = TEST ? NetworkParameters.testNet3() : NetworkParameters.prodNet();

	private static final String WALLET_FILENAME_PROD = "fastcoin-wallet";
	private static final String WALLET_FILENAME_TEST = "fastcoin-wallet"; //-testnet
	public static final String WALLET_FILENAME = TEST ? WALLET_FILENAME_TEST : WALLET_FILENAME_PROD;

	private static final String WALLET_FILENAME_PROTOBUF_PROD = "fastcoin-wallet-protobuf";
	private static final String WALLET_FILENAME_PROTOBUF_TEST = "fastcoin-wallet-protobuf"; //-testnet
	...
	private static final String EXTERNAL_WALLET_KEY_BACKUP_PROD = "fastcoin-wallet-keys";
	private static final String EXTERNAL_WALLET_KEY_BACKUP_TEST = "fastcoin-wallet-keys"; ///-testnet
	...
	private static final String WALLET_KEY_BACKUP_SNAPSHOT_PROD = "fastcoin-key-backup-snapshot";
	private static final String WALLET_KEY_BACKUP_SNAPSHOT_TEST = "fastcoin-key-backup-snapshot"; //-testnet
	...
	private static final String BLOCKCHAIN_FILENAME_PROD = "fastcoin-blockchain";
	private static final String BLOCKCHAIN_FILENAME_TEST = "fastcoin-blockchain"; //-testnet
	...
	public static final String MIMETYPE_TRANSACTION = "application/x-fsttx";

	public static final int MAX_NUM_CONFIRMATIONS = 4;
	public static final String USER_AGENT = "Fastcoin Wallet";
	public static final String DEFAULT_EXCHANGE_CURRENCY = "USD";
	public static final int WALLET_OPERATION_STACK_SIZE = 256 * 1024;
	public static final long BLOCKCHAIN_DOWNLOAD_THRESHOLD_MS = 10 ;//1 * DateUtils.SECOND_IN_MILLIS; //5
	...
	public static final String CURRENCY_CODE_BITCOIN = "FST";
	...
	public static final String DONATION_ADDRESS = "g2bwsYnf2yYiubqbBrMLSUvLmfRjBuAbnW";
	...
	public static final String WEBMARKET_APP_URL = "http://fastcoin.ws";//https://play.google.com/store/apps/details?id=%s
	public static final String MARKET_PUBLISHER_URL = ""; //market://search?q=pub:"Andreas Schildbach"

	public static final String VERSION_URL = "http://fastcoin.ws/wallet/android/version.jsp";//https://wallet.schildbach.de/version";
	...
	public static final String PREFS_KEY_BTC_PRECISION = "fst_precision";
