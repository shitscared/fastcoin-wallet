...
import com.google.fastcoin.params.TestNet3Params;
...
public class Constants
{
	...
	public static final String WALLET_FILENAME_PROTOBUF = "fastcoin-wallet-protobuf" + FILENAME_NETWORK_SUFFIX;

	public static final String WALLET_KEY_BACKUP_BASE58 = "fastcoin-key-backup-base58" + FILENAME_NETWORK_SUFFIX;
	public static final String WALLET_KEY_BACKUP_PROTOBUF = "fastcoin-key-backup-protobuf" + FILENAME_NETWORK_SUFFIX;

	public static final File EXTERNAL_WALLET_BACKUP_DIR = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS);
	public static final String EXTERNAL_WALLET_KEY_BACKUP = "fastcoin-wallet-keys" + FILENAME_NETWORK_SUFFIX;

	public static final String BLOCKCHAIN_FILENAME = "fastcoin-blockchain" + FILENAME_NETWORK_SUFFIX;

	public static final String CHECKPOINTS_FILENAME = "fastcoin-checkpoints" + FILENAME_NETWORK_SUFFIX;
	...
	public static final String CURRENCY_CODE_FST = "FST";
	public static final String CURRENCY_CODE_MFST = "mFST";
	...
	public static final int FST_MAX_PRECISION = 8;
	public static final int MFST_MAX_PRECISION = 5;
	public static final int LOCAL_PRECISION = 4;

	public static final String DONATION_ADDRESS = "ftiuwo6JMgfq5vy9RXqCLnnQ6wHBYFNH7r";
	public static final String REPORT_EMAIL = "info@fastcoin.ca";
	public static final String REPORT_SUBJECT_ISSUE = "Reported issue";
	public static final String REPORT_SUBJECT_CRASH = "Crash report";

	public static final String LICENSE_URL = "http://www.gnu.org/licenses/gpl-3.0.txt";
	public static final String SOURCE_URL = "https://github.com/shitscared/fastcoin-wallet";
	public static final String BINARY_URL = "http://www.fastcoin.ws"; //http://code.google.com/p/bitcoin-wallet/downloads/list
	public static final String CREDITS_BITCOINJ_URL = "http://code.google.com/p/fastcoinj/";
	public static final String CREDITS_ZXING_URL = "http://code.google.com/p/zxing/";
	public static final String CREDITS_ICON_URL = ""; //https://bitcointalk.org/index.php?action=profile;u=2062
	public static final String AUTHOR_TWITTER_URL = "https://twitter.com/#!/fstcoin";
