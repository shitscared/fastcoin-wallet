...
import com.google.fastcoin.protocols.payments.PaymentRequestException;
import com.google.fastcoin.protocols.payments.PaymentSession;
import com.google.fastcoin.protocols.payments.PaymentProtocol.PkiVerificationData;
...
public final class PaymentProtocol
{
	...
	public static PaymentIntent parsePaymentRequest(@Nonnull final byte[] serializedPaymentRequest) throws PaymentRequestException
	{
		try
		{
            ...
            final String pkiName = null;
            final String pkiOrgName = null;
