...
import com.google.fastcoin.core.ProtocolException;
import com.google.fastcoin.core.Transaction;
import com.google.fastcoin.protocols.payments.PaymentRequestException;
import com.google.fastcoin.protocols.payments.PaymentRequestException.PkiVerificationException;
import com.google.fastcoin.uri.BitcoinURI;
import com.google.fastcoin.uri.BitcoinURIParseException;
			...
			else if (input.startsWith("bitcoin:"))
			{
				try
				{
					...
					if (address.getParameters().equals(Constants.NETWORK_PARAMETERS))
						handlePaymentIntent(PaymentIntent.fromFastcoinUri(bitcoinUri));
					else
